...
- **Added firmware for Cicada 60 Split Space with teensy-lc in [`keyboard/cicada60_teensy_lc`](keyboard/cicada60_teensy_lc).**
- **Added firmware for Satan GH60 (Rev.CHN) in [`keyboard/satan`](keyboard/satan). See [`keyboard/satan/README.md`](keyboard/satan/README.md) for more information.**
